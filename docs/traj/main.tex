...
\todo[inline]{As we don't have quality plots from the last flight, we didn't write up things about it in this section as we expect to have a much better opportunity to do so next quarter. For plots, see the presentation slides we made about it.}
