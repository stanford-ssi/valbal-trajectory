...
\cite{das2003optimal} Linearize the wind field to allow blah blah

We don't wanna discretize or linearize

Furthermore we want a state-feedback policy

Look at some fucked up nonlinear state feedback MPC examples in literature
...
\todo[inline]{Full algorithm written out explicitly}
...
\todo[inline]{Is it worth adding to this? Due to valve stuff it seems maybe not worth it}
